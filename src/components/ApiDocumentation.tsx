...
const endpointDocs = [
  ...
  { method: 'POST', path: '/api/orders/external', scope: 'orders:write', description: 'Mengirim pesanan baru ke Ngolab; pembayaran selalu dimulai sebagai belum_bayar dan diverifikasi staf.' },
  { method: 'POST', path: '/api/orders/external/:id/payment-proof', scope: 'orders:write', description: "Upload JPG/PNG/GIF/WEBP maksimal 5 MB sebagai multipart field 'payment_proof'; status menjadi pending_verifikasi. Hanya berlaku untuk pesanan yang dibuat API Key yang sama; pesanan lama tanpa pemilik terdaftar ditolak dengan HTTP 409 dan diverifikasi manual oleh staf." }
];

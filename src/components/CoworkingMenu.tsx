  ...
  return (
    <div className="space-y-8 pb-12">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <button onClick={() => setIsAddModalOpen(true)} className="flex items-center gap-2 px-5 py-3 rounded-2xl text-xs font-black uppercase tracking-widest bg-amber-600 text-white shadow-lg shadow-amber-200 dark:shadow-none hover:bg-amber-700 hover:shadow-amber-300 dark:shadow-none transition-all self-start md:self-auto">
            ...
            >
              ...
              <form onSubmit={handleAddProduct} className="space-y-5">
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  <button type="submit" className="flex-[2] py-4 bg-amber-600 text-white rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-lg shadow-amber-100 dark:shadow-none hover:bg-amber-700 transition-all">Simpan Menu</button>
                </div>
              </form>
            </motion.div>
          </div>
            ...
            >
              ...
              <form onSubmit={handleUpdateProduct} className="space-y-5">
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  <button type="submit" className="flex-[2] py-4 bg-amber-600 text-white rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-lg shadow-amber-100 dark:shadow-none hover:bg-amber-700 transition-all">Simpan Perubahan</button>
                </div>
              </form>
            </motion.div>
          </div>
